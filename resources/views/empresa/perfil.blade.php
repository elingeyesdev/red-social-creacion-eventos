                ...
                <div class="profile-header">
                    <div class="d-flex align-items-center justify-content-between">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                <h2 class="mb-0" id="header_nombre_empresa">Mi Perfil</h2>
                                <p class="mb-0">Información completa de tu cuenta Empresa</p>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="card info-card">
                            ...
                            <div class="card-body p-0">
                                <div class="info-item">
                                    ...
                                    <div class="info-value" id="nombre_empresa">-</div>
                                </div>
                                <div class="info-item">
                                    <div class="info-label">
                    ...
                    <div class="card-body" style="padding: 2rem;">
                        <form id="profileForm">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label><i class="fas fa-building mr-1"></i> Nombre de la Empresa</label>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="edit_descripcion" name="descripcion" rows="4" placeholder="Describe tu empresa..."></textarea>
                                    </div>
                                </div>
                            </div>
...
function displayProfile(data) {
    // Header
    if (data.empresa && data.empresa.nombre_empresa) {
        document.getElementById('header_nombre_empresa').textContent = data.empresa.nombre_empresa;
    }

    // Mostrar foto de perfil
    const fotoPerfil = data.empresa?.foto_perfil || data.foto_perfil;
    if (fotoPerfil) {
    ...
    // Información de Empresa
    if (data.empresa) {
        document.getElementById('nombre_empresa').textContent = data.empresa.nombre_empresa || '-';
        document.getElementById('nit').textContent = data.empresa.NIT || '-';
        document.getElementById('telefono').textContent = data.empresa.telefono || '-';
        document.getElementById('direccion').textContent = data.empresa.direccion || '-';
        document.getElementById('sitio_web').innerHTML = data.empresa.sitio_web 
            ? `<a href="${data.empresa.sitio_web}" target="_blank" class="text-primary"><i class="fas fa-external-link-alt mr-1"></i>${data.empresa.sitio_web}</a>` 
            : '-';
        document.getElementById('descripcion').textContent = data.empresa.descripcion || 'No hay descripción disponible.';
    }
}
...
function populateEditForm() {
    ...
    if (profileData.empresa) {
        document.getElementById('edit_nombre_empresa').value = profileData.empresa.nombre_empresa || '';
        document.getElementById('edit_nit').value = profileData.empresa.NIT || '';
        document.getElementById('edit_telefono').value = profileData.empresa.telefono || '';
        document.getElementById('edit_direccion').value = profileData.empresa.direccion || '';
        document.getElementById('edit_sitio_web').value = profileData.empresa.sitio_web || '';
        document.getElementById('edit_descripcion').value = profileData.empresa.descripcion || '';
    }
}
