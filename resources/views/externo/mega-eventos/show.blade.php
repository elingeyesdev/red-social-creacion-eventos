    ...
    <div id="megaEventoContent" style="display: none;">
        ...
        <div class="container mt-4">
            ...
            <div class="d-flex justify-content-end mb-4 flex-wrap" style="gap: 0.75rem;">
                ...
                <button class="btn btn-outline-primary" id="btnCompartir" style="border-radius: 12px; padding: 0.6rem 1.5rem; font-weight: 500; transition: all 0.3s ease; border-color: #0C2B44; color: #0C2B44; box-shadow: 0 2px 8px rgba(12,43,68,0.2);" onmouseover="this.style.transform='translateY(-2px)'; this.style.boxShadow='0 4px 12px rgba(12,43,68,0.3)'; this.style.background='#0C2B44'; this.style.color='white'" onmouseout="this.style.transform='translateY(0)'; this.style.boxShadow='0 2px 8px rgba(12,43,68,0.2)'; this.style.background='transparent'; this.style.color='#0C2B44'">
