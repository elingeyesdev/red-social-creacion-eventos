                ...
                <div class="profile-header">
                    <div class="d-flex align-items-center justify-content-between">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                <h2 class="mb-0" id="header_nombre_ong">Mi Perfil</h2>
                                <p class="mb-0">Información completa de tu cuenta ONG</p>
                            </div>
                        </div>
                    </div>
                </div>
...
function displayProfile(data) {
    // Header
    if (data.ong && data.ong.nombre_ong) {
        document.getElementById('header_nombre_ong').textContent = data.ong.nombre_ong;
    }

    // Mostrar foto de perfil
    const fotoPerfil = data.ong?.foto_perfil || data.foto_perfil;
    if (fotoPerfil) {
    ...
    // Información de ONG
    if (data.ong) {
        document.getElementById('nombre_ong').textContent = data.ong.nombre_ong || '-';
        document.getElementById('nit').textContent = data.ong.NIT || '-';
...
function populateEditForm() {
    ...
    if (profileData.ong) {
        document.getElementById('edit_nombre_ong').value = profileData.ong.nombre_ong || '';
        document.getElementById('edit_nit').value = profileData.ong.NIT || '';
        document.getElementById('edit_telefono').value = profileData.ong.telefono || '';
        document.getElementById('edit_direccion').value = profileData.ong.direccion || '';
        document.getElementById('edit_sitio_web').value = profileData.ong.sitio_web || '';
        document.getElementById('edit_descripcion').value = profileData.ong.descripcion || '';
    }
}
